...
namespace ItemCompare
{
    ...
    internal class ByteTagDefinition
    {
        ...
        static ByteTagDefinition()
        {
            ...
            registeredTagDefinitions.Add(new TagDefinitionKey("*", "*", "*", "0xD1"), new ByteTagDefinition(new Vector(2.5, -0.5), -90));
            registeredTagDefinitions.Add(new TagDefinitionKey("*", "*", "*", "0xD2"), new ByteTagDefinition(new Vector(2.5, -0.5), -90));
            ...
            registeredTagDefinitions.Add(new TagDefinitionKey("*", "*", "*", "0xC4"), new ByteTagDefinition(new Vector(2.5, -0.5), -90));
            registeredTagDefinitions.Add(new TagDefinitionKey("*", "*", "*", "0xC5"), new ByteTagDefinition(new Vector(2.5, -0.5), -90));
            registeredTagDefinitions.Add(new TagDefinitionKey("*", "*", "*", "0xC6"), new ByteTagDefinition(new Vector(2.5, -0.5), -90));
        }
